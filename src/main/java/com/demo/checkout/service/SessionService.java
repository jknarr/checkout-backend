...
import com.demo.checkout.dto.response.ShippingAddressResponse;
...
public class SessionService {
    ...
    @Transactional
    public SessionResponse createSession(com.demo.checkout.dto.request.CreateSessionRequest req) {
        String cartJson;
        try {
